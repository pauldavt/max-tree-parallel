...
int main()
{
  using prim = pmt::primitives<index_t, index_t, 2>;
  ...
  pmt::thread_pool.for_all_blocks<prim>(
    image_blocks.dimensions(), [=, &image_blocks](vec_t loc, pmt::thread_nr_t t) {
